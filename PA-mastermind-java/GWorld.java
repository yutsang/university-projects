...
/**
 * GWorld - Utility and world management functions for the Mastermind Java game using Greenfoot.
 * Provides static methods for manipulating the world and its actors.
 * 
...
{
    // Static configuration for world size and cell size
    ...
    /**
     * Set the cell size of the world.
     */
    public static void setCellSize(int s) { cellSize = s; }

    /**
     * Constructor for GWorld. Sets up the world and registers it.
     */
    protected GWorld() {    
   ...
   // ====================================
     ...
     * 
     */
    public static Actor[] getAllObjectsAt(int x, int y, String actorClassName) {
         if ( wobj == null )
            return null ;
